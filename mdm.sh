...
select opt in "${options[@]}"; do
	...
	"Bypass on Recovery")
		...
		echo "0.0.0.0 deviceenrollment.apple.com" >>/Volumes/Disk/etc/hosts
		echo "0.0.0.0 mdmenrollment.apple.com" >>/Volumes/Disk/etc/hosts
		echo "0.0.0.0 iprofiles.apple.com" >>/Volumes/Disk/etc/hosts
